...
class ExperimentArgs:
    ...
    data_path: str = field(
        default='/home/user36/test_time_gd/data/N1-K4V4-S4_32-64_1M',
    )
...
if __name__ == '__main__':
    ...
    if args.base_model == 'gpt2':
        ...
        config.intermediate_size = config.hidden_size * 4
    elif args.base_model == 'gpt_neox':
        config = AutoConfig.from_pretrained('/home/user36/metamem/src/configs/base_models/exp/gpt_neox_tiny_4l4hd128.json')
    else:
    ...
    model.model.load_state_dict(torch.load('/home/user36/metamem/runs/neox_noisy_ar.pth'))

    # dataset = datasets.load_from_disk(args.data_path)
    dataset = datasets.load_dataset("yurakuratov/N2-K4V4-S1_16-32_1M")
